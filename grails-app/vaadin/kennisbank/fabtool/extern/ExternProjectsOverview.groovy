 ...
 */
class ExternProjectsOverview extends Panel implements View {
	...
	ExternProjectsOverview() {
		...
		// setPrimaryStyleName("island-panel")
		...
		for (checkout in checkouts) {
			...
			newLink.addLayoutClickListener(new LayoutClickListener() {
				...
				public void layoutClick(LayoutClickEvent event) {
					// ExternProjectView newView = new ExternProjectView(newLink.checkout)
					
					def uriString = newLink.checkout.title.replace(" ", "-")
					UI.getCurrent().navigator.navigateTo("project/"+uriString)
				}
			})
		}
	}
